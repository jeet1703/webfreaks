...
function Hero() {
  return (
    <>
      <section className="relative h-screen  text-white flex items-center justify-center font-quicksand ">
        ...
        <div className="relative z-20 grid grid-cols-1 md:grid-cols-3 gap-8 mx-4 md:mx-24 px-4">
          ...
          <div className="md:col-span-1 flex flex-col items-start justify-center space-y-6 p-6 md:p-10 font-nunito">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 font-quicksand">Welcome Mortal,</h1>
            ...
            <p className="text-sm md:text-base mb-8">
              ...
              would love to <br /> have you on our side in the spaceship and <br />
          ...
          <div className="md:col-span-2 flex items-center justify-center p-6 md:p-10 relative">
            <div className="relative">
              <img
                src="/eclipse.png"
                alt="Astronaut"
                className="w-full max-w-sm md:max-w-md lg:max-w-lg transform"
              />
            </div>
          </div>
        </div>
      ...
      {/* New Section */}
      <section className="relative text-white flex items-center justify-center font-quicksand bg-blue-900">
      <div className="relative z-20 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-4 md:mx-24 px-4 items-center">
        {/* Kid Image */}
        

        {/* Text Content */}
        <div className="relative z-20 justify-end  text-center md:text-left p-6 md:p-10">
          <h2 className="text-2xl md:text-4xl font-bold text-yellow-400">But wait a minute <br/> who are <span className="text-white">you?</span></h2>
            ...
            <img
              src="kidmin.png"
              alt="Kid"
              className=" hidden  md:block md:w-[30em] h-auto z-30 absolute bottom-0 left-0 "
            />
            
         
      <div className="absolute bottom-0 w-full h-2 bg-pink-400 z-20"></div>
    </section>
    </>
  );
}
