...
const Stairs = () => {
  return (
    <div className="flex h-screen bg-black text-white">
      ...
      <div className="w-1/2 flex font-quicksand flex-col items-start justify-center p-10 ">
        <h1 className="text-4xl font-bold mb-8 font-nunito">Where does it come from?</h1>
        <p className="mb-4">
